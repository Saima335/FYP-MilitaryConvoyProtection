...
const UserInput = ({ navigation }) => {
    ...
    const checkTextInput = () => {
        ...
        if(sourceCoordinates!=="" && destinationCoordinates!==""){
            navigation.navigate('Analysis Path',{sourceCoordinates: sourceCoordinates, destinationCoordinates: destinationCoordinates });
        }
        else{
    ...
    return (
        <View style={{ height: 1000, backgroundColor: 'black', }}>
            <View style={{
                ...
                <GooglePlacesAutocomplete
                    ...
                    onPress={(data, details = null) => {
                        ...
                        setSourceCoordinates(JSON.stringify(details?.geometry?.location));
                    }}
            ...
            <View style={{
                ...
                >
                    <Text style={{ textAlign: "center", margin: 12, fontWeight: "bold", }}>Find Risk</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
